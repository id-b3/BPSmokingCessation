...
df['bp_wt_avg'] = df[['bp_wt_3', 'bp_wt_4', 'bp_wt_5', 'bp_wt_6']].mean(axis=1)
df['bp_ir_avg'] = df[['bp_ir_3', 'bp_ir_4', 'bp_ir_5', 'bp_ir_6']].mean(axis=1)
df['bp_or_avg'] = df[['bp_or_3', 'bp_or_4', 'bp_or_5', 'bp_or_6']].mean(axis=1)
